...
class SusiStateMachine(Thread):
    ...
    def __init__(self, renderer=None):
        ...
        self.__idle_state.allowedStateTransitions = \
            {'recognizing': self.__recognizing_state, 'error': self.__error_state, 'idle': self.__idle_state}
        self.__recognizing_state.allowedStateTransitions = \
            {'busy': self.__busy_state, 'error': self.__error_state, 'idle': self.__idle_state}
